...
* このゲームの目的は、敵機を弱らせて**撤退**させることです。破壊することではありません。
  ...
  * もたもたしていると、増援が出現します。
  * 敵艦を破壊すると、敵意を煽ってしまい、増援が出現し、スコアも減点され、**残った敵の士気が上がります**。つまり、撃破は逆効果です。
    * 士気が上がった敵は、より深く削られるまで逃げ出さず、より近づいてから撃ってきます。
    * 撃破したのが味方（連邦艦）でも同じです。味方に敵を倒させても得はしません。
...
* **敵も味方も誤射はしません。** 射線上に自分の仲間がいるときは撃たず、回り込みます。誤射をするのはプレーヤーだけです。
...
* **とどめを刺さない。** あと一撃で落ちる敵ほど、撃たずに追い出すほうが得です。
  撃破すると残った敵が粘り強くなり、追い返すのに要る手数がかえって増えます。
